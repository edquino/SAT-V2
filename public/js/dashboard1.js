...
$(function() {
    ...
    var chart = c3.generate({
        ...
        color: {
            pattern: ['#eceff1', '#24d2b5', '#0036b4', '#0036b4']
        }
    });
    // ============================================================== 
    // Our Income
    ...
    var chart = c3.generate({
        ...
        color: {
            pattern: ['#ff9041', '#0036b4', '#24d2b5', '#0036b4'], // the three color levels for the percentage values.
            threshold: {
    ...
    Morris.Area({
        ...
        pointSize: 0,
        fillOpacity: 0,
        pointStrokeColors: ['#0036b4', '#24d2b5', '#0036b4'],
        behaveLikeLine: true,
        gridLineColor: '#e0e0e0',
        lineWidth: 3,
        hideHover: 'auto',
        lineColors: ['#0036b4', '#24d2b5', '#0036b4'],
        resize: true
